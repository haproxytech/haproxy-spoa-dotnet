...
{
    [TestFixture]
    public class ListOfActionsPayloadTests
    {
        [Test]
        public void Bytes_WhenContainsAction_ReturnsExpectedResult()
        {
            // arrange
            var payload = new ListOfActionsPayload();
            payload.Actions.Add(new SetVariableAction(VariableScope.Session, "ip_score", new TypedData(DataType.Int32, 5)));
            ...
            Assert.AreEqual(
                ...
                HelperMethods.ToBitString(payload.Bytes));
        }
    }
}